namespace Sports_Merchandise_Store.Migrations
{
    ...
    public partial class teamandplayerstable : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Teams", t => t.PlayerTeamId, cascadeDelete: true)
                .Index(t => t.PlayerTeamId);
                ...
                c => new
                    {
                        ...
                        TeamBudget = c.Decimal(nullable: false, precision: 18, scale: 2),
                    })
